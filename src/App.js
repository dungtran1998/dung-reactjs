...
function App() {
  return (
    <>
      {/*!-- header start --*/}
      <header>
        <div id="header-sticky" classNameName="header-area box-90 sticky-header">
                ...
                <div className="header-right f-right">
                  <ul>
                    <li className="search-btn">
                      <a className="search-btn nav-search search-trigger" href="#"><i classNameName="fas fa-search"></i></a>
                    </li>
                    <li className="login-btn"><a href="#"><i classNameName="far fa-user"></i></a></li>
                    <li className="d-shop-cart"><a href="#"><i classNameName="fas fa-shopping-cart"></i> <span classNameName="cart-count">3</span></a>
                      <ul className="minicart">
                        <li>
                          <div classNameName="cart-img">
                            <a href="#">
